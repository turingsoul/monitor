...
public class SchedulerResourceUtil {
    ...
    public static HashMap<String, Serializable> handlePDIScheduling( String file,
        ...
        if ( file != null && isPdiFile( file ) ) {
            ...
            convertedParameterMap.put( "directory", FilenameUtils.getPathNoEndSeparator( file ) );

            String type = isTransformation( file ) ? "transformation" : "job";
            convertedParameterMap.put( type, FilenameUtils.getBaseName( file ) );
    ...
    public static boolean isPdiFile( String file ) {
        return isTransformation( file ) || isJob( file );
    }

    public static boolean isTransformation( String file ) {
        return file != null && "ktr".equalsIgnoreCase( FilenameUtils.getExtension( file ) );
    }

    public static boolean isJob( String file ) {
        return file != null && "kjb".equalsIgnoreCase( FilenameUtils.getExtension( file ) );
    }
