...
import com.xdatainsight.monitor.web.http.session.PentahoHttpSession;
...
public class HttpSessionPentahoSessionIntegrationFilter implements Filter, InitializingBean {
    ...
    static final String FILTER_APPLIED = "__session_integration_filter_applied"; //$NON-NLS-1$
     ...
     * argument is value from {@code /pentaho-system/anonymous-authentication/anonymous-user} from {@code monitor.xml}.
