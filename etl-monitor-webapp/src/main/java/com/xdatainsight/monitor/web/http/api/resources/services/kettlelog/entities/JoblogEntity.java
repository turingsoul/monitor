...
public class JoblogEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (executingUser != null ? !executingUser.equals(that.executingUser) : that.executingUser != null)
            return false;
        if (startJobEntry != null ? !startJobEntry.equals(that.startJobEntry) : that.startJobEntry != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = idJob != null ? idJob.hashCode() : 0;
        ...
        result = 31 * result + (startJobEntry != null ? startJobEntry.hashCode() : 0);
