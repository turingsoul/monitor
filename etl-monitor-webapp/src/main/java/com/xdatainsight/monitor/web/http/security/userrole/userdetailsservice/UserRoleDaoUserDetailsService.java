package com.xdatainsight.monitor.web.http.security.userrole.userdetailsservice;
...
public class UserRoleDaoUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        ...
        XdtUser user;
        try {
            user = ((XdtUser) userRoleDao.getUser(null, username));
        } catch (UncategorizedUserRoleDaoException e) {
            throw new UserRoleDaoUserDetailsServiceException("UserRoleDaoUserDetailsService.ERROR_0003_DATA_ACCESS_EXCEPTION", e);
        }

        if (user == null) {
            throw new UsernameNotFoundException("UserRoleDaoUserDetailsService.ERROR_0001_USER_NOT_FOUND");
        } else {
            ...
            if (dbAuths.size() == 0) {
                throw new UsernameNotFoundException("UserRoleDaoUserDetailsService.ERROR_0002_NO_AUTHORITIES");
            }
