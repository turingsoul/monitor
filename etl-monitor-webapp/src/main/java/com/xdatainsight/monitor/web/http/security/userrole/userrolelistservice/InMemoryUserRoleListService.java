...
import com.xdatainsight.monitor.web.http.security.UserRoleListEnhancedUserMap;
...
public class InMemoryUserRoleListService implements IUserRoleListService, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        Assert.notNull( userRoleListEnhancedUserMap, "InMemoryUserRoleListService.ERROR_0001_PROPERTY_LIST_NOT_SPECIFIED" ); //$NON-NLS-1$
        Assert.notNull( allRoles, "InMemoryUserRoleListService.ERROR_0002_ALL_AUTHORITIES_NOT_SPECIFIED" ); //$NON-NLS-1$
        Assert.notNull( userDetailsService, "InMemoryUserRoleListService.ERROR_0003_USERDETAILSSERVICE_NOT_SPECIFIED" ); //$NON-NLS-1$
    }
