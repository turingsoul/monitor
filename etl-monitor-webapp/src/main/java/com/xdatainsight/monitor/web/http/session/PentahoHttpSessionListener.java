...
package com.xdatainsight.monitor.web.http.session;
...
public class PentahoHttpSessionListener implements HttpSessionListener {
    ...
    public void sessionCreated( final HttpSessionEvent event ) {
        ...
        if ( PentahoHttpSessionListener.debug ) {
            Logger.debug( this, "HttpSessionListener.DEBUG_SESSION_CREATED" ); //$NON-NLS-1$
        }
    ...
    public void sessionDestroyed( final HttpSessionEvent event ) {
        ...
        try {
            ...
            Logger.error( this, "HttpSessionListener.ERROR_0001_ERROR_DESTROYING_SESSION", e ); //$NON-NLS-1$
        }
